...
/*Fonction qui recherche toutes les séquences dans le fichier puis
demande à l'utilisateur lesquelles il souhaite utiliser*/
...
Elle procède ensuite à l'alignement des séquences*/
